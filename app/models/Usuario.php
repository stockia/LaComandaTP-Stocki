...
class Usuario {
    ...
    public function InsertarUsuario() {
        ...
        $consulta = $objetoAccesoDato->RetornarConsulta("INSERT INTO usuarios (nombre, rol, username, password, statusUsuario) VALUES (:nombre, :rol, :username, :password, :statusUsuario)");
